...
const Login: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-slate-950 relative overflow-y-auto overflow-x-hidden">
      ...
      {/* Content Wrapper - min-h-full ensures centering on large screens, allows scrolling on small screens */}
      <div className="min-h-full flex items-center justify-center p-4 md:p-8 relative z-10">
        <div className="w-full max-w-5xl bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border border-slate-800 flex flex-col md:flex-row relative z-10 my-auto">
